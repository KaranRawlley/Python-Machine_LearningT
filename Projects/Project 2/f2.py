...
# 		
# 		self.root = root
# 		self.root.wm_title("The Book Store")
# 		
...
# 		
# 		self.title_text	=	StringVar()
# 		self.e1	=	Entry(root,textvariable=self.title_text,bd=4)
# 		self.e1.grid(row=0,column=1)
# 		
# 		self.author_text	=	StringVar()
# 		self.e2	=	Entry(root,textvariable=self.author_text,bd=4)
# 		self.e2.grid(row=0,column=3)
# 		
# 		self.year_text	=	StringVar()
# 		self.e3	=	Entry(root,textvariable=self.year_text,bd=4)
# 		self.e3.grid(row=1,column=1)
# 		
# 		self.isbn_text	=	StringVar()
# 		self.e4	=	Entry(root,textvariable=self.isbn_text,bd=4)
# 		self.e4.grid(row=1,column=3)
# 		
...
# 		sb1.config(command=self.list1.yview)
# 		
# 		b1	=	Button(root,text='View all',width=12,command=self.view_command)
# 		b1.grid(row=2,column=3)
# 		
# 		b2	=	Button(root,text='Search entry',width=12,command=self.search_command)
# 		b2.grid(row=3,column=3)
# 		
# 		b3	=	Button(root,text='Add entry',width=12,command=self.add_command)
# 		b3.grid(row=4,column=3)
# 		
# 		b4	=	Button(root,text='Update selected',width=12,command=self.update_command)
# 		b4.grid(row=5,column=3)
# 		
# 		b5	=	Button(root,text='Delete selected',width=12,command=self.delete_command)
# 		b5.grid(row=6,column=3)
# 		
